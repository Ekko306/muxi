      ...
      <div className="home-layout">
        ...
        >
          ...
          <div className="home-content">
            <Route path={`${url}/auction`} exact component={Auction} />
            <Route path={`${url}/market`} exact component={Market} />
            <Route path={`${url}/order`}  component={Order} />
            <Route path={`${url}/user`} exact component={User} />
            <Route path={`${url}/finance`} exact component={Finance} />
            <Route path={`${url}/operation`} exact component={Operation} />
